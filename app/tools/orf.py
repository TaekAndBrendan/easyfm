...
def find_orf(d):
    _find_orf(fileName=d['fileName'], outputFileName=d['nuclfileName'], 
                    minProLen=d['minProLen'], maxProLen=d['maxProLen'],
                    sequenceType='nucl', translationTable=d['translationTable'])

    _find_orf(fileName=d['fileName'], outputFileName=d['protfileName'], 
                    minProLen=d['minProLen'], maxProLen=d['maxProLen'],
                    sequenceType='prot', translationTable=d['translationTable'])

def _find_orf(fileName, 
                outputFileName, 
                minProLen=30, 
                maxProLen=0, 
                hitsToPull=3, 
